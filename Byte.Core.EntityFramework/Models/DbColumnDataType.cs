namespace Byte.Core.EntityFramework.Models
{
    ...
    public class DbColumnTypeCollection
    {
        public static IList<DbColumnDataType> DbColumnDataTypes => new List<DbColumnDataType>()
        {
            ...
            new DbColumnDataType(){ DatabaseType = DatabaseType.MSSQL, ColumnTypes = "uniqueidentifier", CSharpType ="TKey"},
            ...
            new DbColumnDataType(){ DatabaseType = DatabaseType.PostgreSQL, ColumnTypes = "uuid", CSharpType ="TKey"},
            ...
            new DbColumnDataType(){ DatabaseType = DatabaseType.Oracle, ColumnTypes = "ANYDATA", CSharpType ="Object"},
