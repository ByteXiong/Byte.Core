...
namespace Byte.Core.EntityFramework.IDbContext
{
    public class MySqlDbContext : BaseDbContext, IMySqlDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //          optionsBuilder.UseMySql(Option.ConnectionString, ServerVersion.AutoDetect(Option.ConnectionString),optionsBuilder => optionsBuilder.EnableRetryOnFailure(
            //    maxRetryCount: 5,
            //    maxRetryDelay: System.TimeSpan.FromSeconds(30),
            //    errorNumbersToAdd: null)
            //);

            var server = ServerVersion.AutoDetect(Option.ConnectionString);
            optionsBuilder.UseMySql(Option.ConnectionString,server);
