...
namespace Byte.Core.EntityFramework.CodeGenerator
{
    ...
    public class CodeGenerator
    {
        ...
        /// <summary>
        /// 生成指定的实体对应IBusinessLogic和BusinessLogic层的基础代码文件
        /// </summary>
        ...
        public void GenerateController<TEntity, TKey>(bool ifExistCovered = false) where TEntity : IBaseModel<TKey>
        {
            var db = new DbTable();
            db.TableName = typeof(TEntity).Name;
            GenerateController(db, typeof(TKey).Name, ifExistCovered);
        ...
        public void GenerateAllCodesFromDatabase(IDbContextCore dbContext, CodeTemplateEnum[] type, bool ifExistCovered = false, Func<DbTable, bool> selector = null)
        {
            var tables = dbContext.GetCurrentDatabaseTableList(selector);
            if (tables != null && tables.Any())
            {
                Generate(tables.ToList(), type, ifExistCovered);
            }
        }
        /// <summary>
        /// 生成代码模板
        ...
        public void GenerateSingle(Type modelType, bool ifExistCovered = false)
        {
            ...
            GenerateIRepository(db, keyTypeName, ifExistCovered);
            GenerateRepository(db, keyTypeName, ifExistCovered);
            GenerateIBusinessLogic(db, keyTypeName, ifExistCovered);
            GenerateBusinessLogic(db, keyTypeName, ifExistCovered);
            GenerateController(db, keyTypeName, ifExistCovered);
        }
        ...
        /// <returns></returns>
        public string ReplaceTemplate(string content, DbTable table, string pkTypeName)
        {
            ...
            content = content
                ...
                .Replace("{KeyTypeName}", pkTypeName)//主键类型
        ...
        public void GenerateModelEntity(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
            ...
            content = ReplaceTemplate(content, table, pkTypeName);
            content = content.Replace("{ModelProperties}", GenerateEntity(table));
            WriteAndSave(fullPath, content);
        }
        public void GenerateModelRequest(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        /// <param name="pkTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateModelParam(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        /// <param name="pkTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateIRepository(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        public void GenerateIRepository<TEntity, TKey>(bool ifExistCovered = false) where TEntity : IBaseModel<TKey>
        {
            var db = new DbTable();
            db.TableName = typeof(TEntity).Name;
            GenerateIRepository(db, typeof(TKey).Name, ifExistCovered);
        ...
        /// <param name="ifExistCovered"></param>
        public void GenerateRepository(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        public void GenerateRepository<TEntity, TKey>(bool ifExistCovered = false) where TEntity : IBaseModel<TKey>
        {
            var db = new DbTable();
            db.TableName = typeof(TEntity).Name;
            GenerateRepository(db, typeof(TKey).Name, ifExistCovered);
        ...
        /// <param name="keyTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateIBusinessLogic(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        public void GenerateIBusinessLogic<TEntity, TKey>(bool ifExistCovered = false) where TEntity : IBaseModel<TKey>
        {
            var db = new DbTable();
            db.TableName = typeof(TEntity).Name;
            GenerateIBusinessLogic(db, typeof(TKey).Name, ifExistCovered);
        }
        /// <summary>
        ...
        /// <param name="keyTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateBusinessLogic(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        public void GenerateBusinessLogic<TEntity, TKey>(bool ifExistCovered = false) where TEntity : IBaseModel<TKey>
        {
            var db = new DbTable();
            db.TableName = typeof(TEntity).Name;
            GenerateBusinessLogic(db, typeof(TKey).Name, ifExistCovered);
        ...
        /// <param name="keyTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateController(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        /// <param name="keyTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateUIList(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
        ...
        /// <param name="keyTypeName"></param>
        /// <param name="ifExistCovered"></param>
        public void GenerateUIEditForm(DbTable table, string pkTypeName, bool ifExistCovered = false)
        {
            var repositoryPath = Option.OutputPath + Delimiter + Option.UINamespace + Delimiter + table.TableName.ToFirstLowerStr();//转小写  
            if (!Directory.Exists(repositoryPath))
            {
