...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  dts_sha_total: () => import("@/views/dts/sha_total/index.vue"),
  dts_user_total: () => import("@/views/dts/user_total/index.vue"),
  ...
  job_detail: () => import("@/views/job_detail/index.vue"),
  ...
  rank_day: () => import("@/views/rank/day/index.vue"),
  rank_week: () => import("@/views/rank/week/index.vue"),
  table_column: () => import("@/views/table/column/index.vue"),
  table_form: () => import("@/views/table/form/index.vue"),
  table_list: () => import("@/views/table/list/index.vue"),
  table_view: () => import("@/views/table/view/index.vue"),
