...
export default {
  ...
  'TableModel.delete_api_tablemodel_delete': ['DELETE', '/api/TableModel/Delete'],
  'TableModel.get_api_tablemodel_getinfo': ['GET', '/api/TableModel/GetInfo'],
  'TableModel.get_api_tablemodel_getpage': ['GET', '/api/TableModel/GetPage'],
  'TableModel.post_api_tablemodel_submit': ['POST', '/api/TableModel/Submit'],
