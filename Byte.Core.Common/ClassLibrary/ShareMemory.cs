...
namespace Byte.Core.Common.ClassLibrary
{
    /// <summary>
    /// 共享内存
    /// </summary>
    ...
    public class ShareMenmory<T>
    {
        ...
        public string GetUrl(int index)
        {
            ...
            return StringExtensions.ToString(Read(200, offset)).Trim();
        }
        ...
        {
            string str = StringExtensions.ToString(Read(entityLength, index * entityLength));
